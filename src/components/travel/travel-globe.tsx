...
function buildPalette(isDark: boolean): GlobePalette {
  if (isDark) {
    return {
      ...
      globe: hslToken("--surface"),
      emissive: hslToken("--background"),
      visitedCountry: hslToken("--primary", 0.62),
      visitedHover: hslToken("--accent", 0.72),
      unvisitedCountry: hslToken("--surface-strong", 0.42),
      unvisitedHover: hslToken("--muted", 0.55),
      strokeVisited: hslToken("--foreground", 0.55),
      strokeUnvisited: hslToken("--border", 0.4),
      side: hslToken("--background", 0.28),
...
const FALLBACK_DARK_PALETTE: GlobePalette = {
  ...
  visitedHover: "rgba(251, 191, 36, 0.72)",
  unvisitedCountry: "rgba(148, 163, 184, 0.18)",
  unvisitedHover: "rgba(148, 163, 184, 0.32)",
  strokeVisited: "rgba(226, 232, 240, 0.5)",
  strokeUnvisited: "rgba(148, 163, 184, 0.16)",
