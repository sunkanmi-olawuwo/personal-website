...
const nigeriaPhotos = [
  {
    src: "/travel/nigeria/lagos-lagoon.png",
    alt: "A stylized sunset over Lagos lagoon and the city skyline.",
    caption: "Lagos lagoon light",
    location: "Lagos",
    takenOn: "Evening archive",
    orientation: "landscape",
    width: 1280,
    height: 880,
  },
  {
    src: "/travel/nigeria/abuja-evening.png",
    alt: "A warm abstract view of Abuja at dusk with layered hills.",
    caption: "Abuja evening calm",
    location: "Abuja",
    takenOn: "Golden hour",
    orientation: "landscape",
    width: 1280,
  ...
  {
    src: "/travel/nigeria/market-colors.png",
    alt: "A vivid market-inspired travel memory with layered city color.",
    caption: "Market color study",
    location: "Southwest Nigeria",
    takenOn: "Memory sketch",
    orientation: "landscape",
    width: 1280,
    height: 880,
  },
